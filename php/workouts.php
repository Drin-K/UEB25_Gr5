...
<body>
    ...
    <div style="padding: 50px; margin-top: 80px;">
      <form method="POST" action="">
        <input
          ...
          style="padding: 10px; width: 250px; border-radius: 5px; border: 1px solid #333;"
          required
        >
        ...
        <button
          ...
          style="padding: 10px 20px; margin-left: 10px; background-color: aquamarine; border: none; border-radius: 5px; cursor: pointer;"
        >
          Go
        </button>
      </form>
  ...
  <script>
    ...
    function goToWorkout() {
      ...
      else alert("Workout not found! Please select a valid option.");
    }
  </script>
</body>
</html>
